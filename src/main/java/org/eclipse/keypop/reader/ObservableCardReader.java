...
public interface ObservableCardReader extends CardReader {
   ...
   *
   * <p>It is <b>mandatory</b> to call this method when the physical communication channel with the
   * card could not be closed properly.<br>
   ...
   *
   * <p>In practice, it is recommended to call this method in all cases (e.g. in a "finally"
